...
public class AdapterRecyclerCompleted extends RecyclerView.Adapter<AdapterRecyclerCompleted.AdapterRecyclerViewHolder>
{

    Context pendingAdapterContext;
    List<AdapterGetterSetter> pandingList;

    public AdapterRecyclerCompleted(Context mContext, List<AdapterGetterSetter> pandingList) {
